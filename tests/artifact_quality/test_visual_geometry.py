...
from tests.artifact_quality.helpers import LEGACY_FIXTURES as FIXTURES, LOCAL_ROOT, RUNNER, ensure_fixtures  # noqa: E402
...
class VisualGeometryTests(unittest.TestCase):
    ...
    def test_quality_score_present(self) -> None:
        ...
        self.assertEqual(report.quality_score.get("instructional_status"), "Manual Review Required")
